...
public static class AppProxyEndpoints
{
    public static void MapAppProxyEndpoints(this IEndpointRouteBuilder app)
    {
    ...
    private static void MapProxyGet(IEndpointRouteBuilder app, string localPath, string? remotePath = null)
    {
        ...
        app.MapGet(localPath, async (DnaServerApi api) =>
        {
            ...
            {
                return AppProxyErrorResults.Create(ex, api.BaseUrl);
            }
        });
    }
