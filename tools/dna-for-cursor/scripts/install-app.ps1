...
if ($null -eq $config.app.hook.ruleFileName -or [string]::IsNullOrWhiteSpace([string]$config.app.hook.ruleFileName)) { $missingFields += "app.hook.ruleFileName" }
...
$effectiveRuleFileName = [string]$config.app.hook.ruleFileName
