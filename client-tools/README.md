# Project DNA 客户端工具 (Client Tools)
...
- [**Cursor**](./dna-for-cursor/README.md) - 深度集成 AI 的现代 IDE，提供自动化配置脚本。
- [**Codex**](./dna-for-codex/README.md) - Codex CLI/IDE 接入工具，生成 `.codex/mcp.json` 与提示模板。
...
1. **配置 MCP 连接**：让 IDE 的 AI 连接本地 DNA Client（如 `http://127.0.0.1:5052/mcp`），调用 `get_context`, `recall`, `remember` 等工具。
